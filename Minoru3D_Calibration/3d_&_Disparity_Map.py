...
#Increasing BM block size increases the accuracy of the disparity map, but also increases the computation time
...
while True:
	...
	if retL and retR:
		...
		disparity = bm.compute(imgL_gray, imgR_gray)
		

		# Convert the disparity map to the correct format
